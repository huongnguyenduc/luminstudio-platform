...
single-instance PostgreSQL and MinIO StatefulSets. All are reachable only
through namespace-local Services. Meilisearch, storage buckets, application
workloads, external routing, backups, and product database schema remain
deferred.
