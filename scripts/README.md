...
## Project Foundation Verification

Validate the Phase 0 product docs and monorepo package boundaries:

```bash
bash scripts/verify-foundation.sh
```

The command runs `bazel query //...` when Bazel is available and reports a
