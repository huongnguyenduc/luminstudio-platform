...
| Task designs, redesigns, or implements user-visible web/mobile UI | Read `docs/UI_SKILLS.md`, query the relevant UI capability, and read each selected skill file completely before planning the visual implementation. |
